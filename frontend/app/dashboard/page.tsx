...
import { api, Factura, Metrics } from '@/utils/api';
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-6">
      ...
      <section className="grid gap-4 md:grid-cols-4">
        ...
        <Metric label="Recuperacion" value={`${metrics.tasa_recuperacion}%`} tone="text-ink" />
      </section>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
              <thead className="border-b text-xs uppercase text-slate-500">
                <tr><th className="py-3">Cliente</th><th>Factura</th><th>Vence</th><th>Dias</th><th className="text-right">Monto</th></tr>
              </thead>
              <tbody>
                {priority.map((row) => (
